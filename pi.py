...
df = pd.read_csv("c:/Users/ADI/Downloads/z-test-master/z-test-master/studentMarks.csv")
...
print("mean of popultion:- ",mean1)
print("Standard deviation of popultion:- ",std_deviation1)
